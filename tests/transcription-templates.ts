/** Uses the standard footer. */
export const imageMD = `*Image Transcription:*
...
/** Uses the old footer without the "human" part. */
export const imageMDOld = `*Image Transcription:*
...
/** Uses the bugged footer with an extra &#32;. */
export const imageMDBugged = `*Image Transcription:*
